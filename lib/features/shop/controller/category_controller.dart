...
class CategoryController extends GetxController {
  ...
  RxList<ProductModel> productForCategories = <ProductModel>[].obs;
  ...
  Future<List<ProductModel>> getCategoryProducts({
    ...
    try {
      ...
      // Gán dữ liệu cho danh sách sản phẩm
      productForCategories.assignAll(products);
      return products;
    } catch (e) {
      TLoaders.errorSnackBar(title: 'Error!', message: e.toString());
      return [];
    } finally {
      // Dừng loading sau khi tải xong
      isLoading.value = false;
    }
  }
